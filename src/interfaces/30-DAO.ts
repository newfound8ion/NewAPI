import {IIdentity, ITxResult, IIssuer, IReciever} from './core';
...
export interface IDao {
  ...
  ): IListResult<IVoteInfoResult>;
  listProposals(
    daoOwner: IIdentity,
    options: IListProposalOptions
  ): IListResult<IProposalInfoResult>;
  propose<Option extends IBaseProposalOptions>(
    issuer: IIssuer,
    dao: IIdentity,
    options: Option
  ): IProposalResult;
  proposeById<Option extends IBaseProposalOptions>(
    issuer: IIssuer,
    daoId: string,
    options: Option
  ): IProposalResult;
